...
(function () {
	...
	var Drawing = useSVG ? svgDrawer : !_isSupportCanvas() ? (function () {
		...
		Drawing.prototype.draw = function (oQRCode) {
          ...
          for (let j=0; j < 4; j++) {
					  drawBitSquare(j,      i, false);
					  drawBitSquare(last-j, i, false);
					  drawBitSquare(i,      j, false);
					  drawBitSquare(i, last-j, false);
          }
				}
			}
          ...
          if (_htOption.addQuietZone)
            offset = 4;
					drawBitSquare(row + offset, col + offset, oQRCode.isDark(row, col));
				}
			}
